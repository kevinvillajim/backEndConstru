...
export class InitialSchema1747071706317 implements MigrationInterface {
    name = 'InitialSchema1747071706317'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`material_requests\` ADD \`notes\` varchar(255) NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`calculation_templates\` CHANGE \`type\` \`type\` enum ('area_volume', 'structural', 'material_estimation', 'budget', 'installation', 'design', 'user_defined', 'architecture', 'HVAC', 'fire_safety', 'efficiency', 'foundation', 'electrical', 'telecommunications') NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`calculation_templates\` CHANGE \`targetProfession\` \`targetProfession\` enum ('architect', 'civil_engineer', 'construction_worker', 'plumber', 'electrician', 'contractor', 'all', 'safety_engineer', 'mechanical_engineer', 'electrical_engineer', 'telecommunications_engineer') NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`calculation_templates\` CHANGE \`targetProfession\` \`targetProfession\` enum ('architect', 'civil_engineer', 'construction_worker', 'plumber', 'electrician', 'contractor', 'all') NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`calculation_templates\` CHANGE \`type\` \`type\` enum ('area_volume', 'structural', 'material_estimation', 'budget', 'installation', 'design', 'user_defined') NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`calculation_templates\` ADD CONSTRAINT \`FK_c00f2503acc369fff5d14531c3d\` FOREIGN KEY (\`created_by\`) REFERENCES \`users\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`calculation_templates\` ADD CONSTRAINT \`FK_8dafddecd6032a3c7f93152c546\` FOREIGN KEY (\`parent_template_id\`) REFERENCES \`calculation_templates\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE \`users\` ADD CONSTRAINT \`FK_4f0f50d9922a0ed51c214f5556b\` FOREIGN KEY (\`admin_id\`) REFERENCES \`users\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`material_requests\` DROP COLUMN \`notes\``);
    }
