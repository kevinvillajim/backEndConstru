...
import {
  ...
  export class CalculationBudgetEntity {
    ...
    // Totales calculados
    @Column({ name: "materials_subtotal", type: "decimal", precision: 12, scale: 2, default: 0 })
    materialsSubtotal: number;
  
    @Column({ name: "labor_subtotal", type: "decimal", precision: 12, scale: 2, default: 0 })
    laborSubtotal: number;
  
    @Column({ name: "professional_costs_total", type: "decimal", precision: 12, scale: 2, default: 0 })
    professionalCostsTotal: number;
  
    @Column({ name: "indirect_costs", type: "decimal", precision: 12, scale: 2, default: 0 })
    indirectCosts: number;
  
    @Column({ name: "contingency_percentage", type: "decimal", precision: 5, scale: 2, default: 5 })
    contingencyPercentage: number;
  
    @Column({ name: "contingency_amount", type: "decimal", precision: 12, scale: 2, default: 0 })
